...
use PIL\TaskerBundle\Entity\CheckList;
use PIL\TaskerBundle\Form\CheckListType;
...
class CheckListController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PILTaskerBundle:CheckList')->findAll();

        return $this->render('PILTaskerBundle:CheckList:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PILTaskerBundle:CheckList:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PILTaskerBundle:CheckList')->find($id);
        ...
        return $this->render('PILTaskerBundle:CheckList:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PILTaskerBundle:CheckList:edit.html.twig', array(
            'entity'      => $entity,
