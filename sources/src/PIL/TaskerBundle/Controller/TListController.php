...
use PIL\TaskerBundle\Entity\TList;
use PIL\TaskerBundle\Form\TListType;
...
class TListController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PILTaskerBundle:TList')->findAll();

        return $this->render('PILTaskerBundle:TList:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PILTaskerBundle:TList:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PILTaskerBundle:TList')->find($id);
        ...
        return $this->render('PILTaskerBundle:TList:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PILTaskerBundle:TList:edit.html.twig', array(
            'entity'      => $entity,
