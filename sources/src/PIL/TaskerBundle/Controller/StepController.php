...
use PIL\TaskerBundle\Entity\Step;
use PIL\TaskerBundle\Form\StepType;
...
class StepController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PILTaskerBundle:Step')->findAll();

        return $this->render('PILTaskerBundle:Step:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PILTaskerBundle:Step:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PILTaskerBundle:Step')->find($id);
        ...
        return $this->render('PILTaskerBundle:Step:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PILTaskerBundle:Step:edit.html.twig', array(
            'entity'      => $entity,
