...
class BoardController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PiloteTaskerBundle:Board')->findAll();

        return $this->render('PiloteTaskerBundle:Board:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PiloteTaskerBundle:Board:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    private function createCreateForm(Board $entity)
    {
        $form = $this->createForm(new BoardType(), $entity, array(
            'action' => $this->generateUrl('crud_board_create'),
            'method' => 'POST',
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PiloteTaskerBundle:Board')->find($id);
        ...
        return $this->render('PiloteTaskerBundle:Board:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PiloteTaskerBundle:Board:edit.html.twig', array(
            'entity'      => $entity,
    ...
    */
    ...
    {
        $form = $this->createForm(new BoardType(), $entity, array(
            'action' => $this->generateUrl('crud_board_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function deleteCheckAction($id)
    {
        ...
        return $this->render('PiloteTaskerBundle:Board:delete_check.html.twig', array(
            'board'      => $entity,
            'delete_form' => $deleteForm->createView(),
        ));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('crud_board_delete', array('id' => $id)))
            ->setMethod('DELETE')
