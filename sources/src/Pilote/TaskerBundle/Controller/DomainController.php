...
use Pilote\TaskerBundle\Form\DomainType;
...
class DomainController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PiloteTaskerBundle:Domain')->findAll();

        return $this->render('PiloteTaskerBundle:Domain:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PiloteTaskerBundle:Domain:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PiloteTaskerBundle:Domain')->find($id);
        ...
        return $this->render('PiloteTaskerBundle:Domain:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PiloteTaskerBundle:Domain:edit.html.twig', array(
            'entity'      => $entity,
