...
use Pilote\TaskerBundle\Form\CheckListOptionType;
...
class CheckListOptionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PiloteTaskerBundle:CheckListOption')->findAll();

        return $this->render('PiloteTaskerBundle:CheckListOption:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PiloteTaskerBundle:CheckListOption:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PiloteTaskerBundle:CheckListOption')->find($id);
        ...
        return $this->render('PiloteTaskerBundle:CheckListOption:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PiloteTaskerBundle:CheckListOption:edit.html.twig', array(
            'entity'      => $entity,
